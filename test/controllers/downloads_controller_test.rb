...
class DownloadsControllerTest < ActionController::TestCase
  ...
  test "should create download" do
    assert_difference('Download.count') do
      post :create, download: { name: @download.name, platforms: @download.platforms, submission_id: @download.submission_id }
    end
  ...
  test "should update download" do
    patch :update, id: @download, download: { name: @download.name, platforms: @download.platforms, submission_id: @download.submission_id }
    assert_redirected_to download_path(assigns(:download))
  end
